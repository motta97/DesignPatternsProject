 ...
 * @author abeer
 */
public class TaskClosedState implements TaskState {

    public TaskClosedState() {
    }
    ...
    public void Reopen(Itasks t) {
        Viewer.DisplayMsg("Transitioning back to In-progress");
    ...
    public void Complete(Itasks t) {
        ...
        t.SetTaskState(new TaskCompleteState());
    }
}
